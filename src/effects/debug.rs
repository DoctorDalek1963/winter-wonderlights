...
mod tests {
    ...
    fn debug_binary_index_test() {
        ...
        assert_eq!(
            ...
            vec![
                FrameType::Off,
                FrameType::RawData(vec![(255, 0, 0), (255, 0, 0), (255, 0, 0), (255, 0, 0), (0, 0, 255), (0, 0, 255), (0, 0, 255), (0, 0, 255)]),
                FrameType::Off,
                FrameType::RawData(vec![(255, 0, 0), (255, 0, 0), (0, 0, 255), (0, 0, 255), (255, 0, 0), (255, 0, 0), (0, 0, 255), (0, 0, 255)]),
                FrameType::Off,
                FrameType::RawData(vec![(255, 0, 0), (0, 0, 255), (255, 0, 0), (0, 0, 255), (255, 0, 0), (0, 0, 255), (255, 0, 0), (0, 0, 255)]),
                FrameType::Off,
            ]
        );
    }
